...
There are a few apps that can falsely trigger Dockside into thinking they are taking up the entire screen, causing it to hide itself, which can be annoying. Unfortunately, this has to be handled manually as explained in next section.

## Ignore/Exclude Certain Apps from Triggering Dockside’s Hide Mode
